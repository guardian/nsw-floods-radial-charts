...
export function radial(results, type, chartId, animationSpeed) {
	...
	console.log(`.${chartId} #graphicContainer`)

	var width = document.querySelector(`.${chartId} #graphicContainer`).getBoundingClientRect().width
	...
	var context = d3.select(`.${chartId} #outer-wrapper`)
